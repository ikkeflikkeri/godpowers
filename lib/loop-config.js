...
const DEFAULTS = {
  ...
  // Rounds one /god-polish loop may run before it closes (hard max 10).
  // The second brake beside the human one: unbounded polish iteration is
  // unbounded cost.
  'polish-rounds-limit': 3
};
